				...
				<div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6'>
						...
						<div className='flex flex-col bg-white rounded-x'>
							<div className='flex-auto p-4 md:p-6'>
								<p className='text-base italic md:text-lg text-gray-800'>
									The level of professionalism, efficiency, and customer care
									demonstrated by Marat truly made a positive impact on my
									travel arrangement.
								</p>
							</div>
						...
						<div className='flex flex-col bg-white'>
							<div className='flex-auto p-4 md:p-6'>
								<p className='text-base italic md:text-lg'>
									I would like to say I am very happy with the services and tour
									which had been provided by Advantour.
								</p>
							</div>
					...
					<div className='flex h-auto border rounded-xl'>
						<div className='flex flex-col bg-white rounded-xl'>
							<div className='flex-auto p-4 md:p-6'>
								<p className='text-base italic md:text-lg text-gray-800'>
									We had a wonderful experience traveling 18 days from the
									Fergana Valley to Nukus. I have already highly recommended
									Advantour to two persons beginning to plan travel to your
									country.
								</p>
							</div>
